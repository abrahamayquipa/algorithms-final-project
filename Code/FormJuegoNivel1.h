...
namespace AdventureForest {
	...
	/// Summary for frmMain
	/// </summary>
	public ref class FormJuegoNivel1 : public System::Windows::Forms::Form
	{
	public:
		FormJuegoNivel1(void)
		{
			InitializeComponent();
			srand(time(NULL));
			...
			bmpMap = gcnew Bitmap("Images\\escenario2.jpg");
	...
	private:
		...
		SoundPlayer^ music = gcnew SoundPlayer("Music\\RUNBTS.wav");
...
#pragma region Windows Form Designer generated code
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(FormJuegoNivel1::typeid));
			   ...
			   this->timer1->Tick += gcnew System::EventHandler(this, &FormJuegoNivel1::timer1_Tick);
			   // 
			   // pnlCanvas
			   // 
			   this->pnlCanvas->BackColor = System::Drawing::Color::LightGray;
			   this->pnlCanvas->Location = System::Drawing::Point(0, 53);
			   this->pnlCanvas->Name = L"pnlCanvas";
			   this->pnlCanvas->Size = System::Drawing::Size(960, 906);
			   ...
			   this->LblSegundos->Location = System::Drawing::Point(854, 0);
			   this->LblSegundos->Name = L"LblSegundos";
			   this->LblSegundos->Size = System::Drawing::Size(72, 48);
			   ...
			   this->label1->Location = System::Drawing::Point(826, 0);
			   ...
			   this->LblMinutos->Location = System::Drawing::Point(765, -2);
			   this->LblMinutos->Name = L"LblMinutos";
			   this->LblMinutos->Size = System::Drawing::Size(72, 48);
			   ...
			   this->LblItems->Location = System::Drawing::Point(613, -4);
			   this->LblItems->Name = L"LblItems";
			   this->LblItems->Size = System::Drawing::Size(46, 48);
			   ...
			   this->LblVidas->Location = System::Drawing::Point(390, -2);
			   this->LblVidas->Name = L"LblVidas";
			   this->LblVidas->Size = System::Drawing::Size(46, 48);
			   ...
			   this->TimerCronometro->Tick += gcnew System::EventHandler(this, &FormJuegoNivel1::TimerCronometro_Tick);
			   // 
			   // panel1
			   // 
			   ...
			   this->panel1->Location = System::Drawing::Point(325, 2);
			   this->panel1->Name = L"panel1";
			   this->panel1->Size = System::Drawing::Size(45, 43);
			   ...
			   this->panel2->Location = System::Drawing::Point(544, 3);
			   this->panel2->Name = L"panel2";
			   this->panel2->Size = System::Drawing::Size(55, 43);
			   ...
			   this->panel3->Location = System::Drawing::Point(724, 4);
			   this->panel3->Name = L"panel3";
			   this->panel3->Size = System::Drawing::Size(38, 43);
			   this->panel3->TabIndex = 14;
			   // 
			   // timerVaccine
			   // 
			   this->timerVaccine->Enabled = true;
			   this->timerVaccine->Tick += gcnew System::EventHandler(this, &FormJuegoNivel1::timerVaccine_Tick);
			   // 
			   // FormJuegoNivel1
			   // 
			   ...
			   this->ClientSize = System::Drawing::Size(960, 960);
			   ...
			   this->Name = L"FormJuegoNivel1";
			   this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			   this->Text = L"FormJuegoNivel1";
			   this->Load += gcnew System::EventHandler(this, &FormJuegoNivel1::FormJuegoNivel1_Load);
			   this->KeyDown += gcnew System::Windows::Forms::KeyEventHandler(this, &FormJuegoNivel1::presionar);
...
#pragma endregion
	...
	private: System::Void TimerCronometro_Tick(System::Object^ sender, System::EventArgs^ e) {
		...
		FormGameOver^ formGameOver = gcnew FormGameOver();
		if (duracion->Minutes == 1  && controller->getPlayer()->getVaccine() != 3) {
			Hide();
