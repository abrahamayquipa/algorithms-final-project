...
namespace AdventureForest {
	...
	/// </summary>
	public ref class FormObjetivosNivel1 : public System::Windows::Forms::Form
	{
	public:
		FormObjetivosNivel1(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(FormObjetivosNivel1::typeid));
			...
			this->label2->Text = L"- Captura los items en 60 segundos.";
			// 
			// label1
			// 
			...
			this->BtnNext->Location = System::Drawing::Point(632, 378);
			this->BtnNext->Name = L"BtnNext";
			this->BtnNext->Size = System::Drawing::Size(125, 41);
			this->BtnNext->TabIndex = 18;
			this->BtnNext->UseVisualStyleBackColor = false;
			this->BtnNext->Click += gcnew System::EventHandler(this, &FormObjetivosNivel1::BtnNext_Click);
			// 
			// panel2
			// 
			...
			this->ClientSize = System::Drawing::Size(858, 447);
			...
			this->Name = L"FormObjetivosNivel1";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"FormObjetivosNivel1";
			this->ResumeLayout(false);
			this->PerformLayout();

		}
	private: System::Void BtnNext_Click(System::Object^ sender, System::EventArgs^ e) {
		FormJuegoNivel1^ formJuegoNivel1 = gcnew FormJuegoNivel1();
		Hide();
		formJuegoNivel1->ShowDialog();
		Close();
		delete formJuegoNivel1;
	}
};
}
